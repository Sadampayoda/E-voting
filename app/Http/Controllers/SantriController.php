...
class SantriController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('santri.index')->with('success', 'User berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('santri.index')->with('success', 'Data pengguna berhasil diperbarui.');
    }
